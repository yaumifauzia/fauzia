...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2018 at 12:33 PM
...
(3, 'Songket', 'lima.jpg', '', 'off'),
(4, 'Silungkang', 'tenun.jpg', '', 'on'),
(5, 'Songket', 'empat.jpg', '', 'on');
...
(16, 1, 'baju', '<p>eegrgtrgtrgregertgr</p>', 'dua.jpg', 2500000, 11, 'on'),
(17, 4, 'songket setelan', '', 'hitam.jpg', 250000, 0, 'on');
...
(4, 5, '122456457568678', 'dela', '2018-07-11');
...
(5, 3, 7, 'dela', '12345678', 'payakumbuh', '2018-07-11 12:48:26', 1),
(6, 3, 7, 'dela', '12345678', 'bukittinggi', '2018-07-11 13:11:43', 0),
(7, 3, 7, 'dela', '12345678', 'payakumbuh', '2018-07-11 13:18:46', 0),
(8, 1, 7, 'dela', '12345678', 'payakumbuh', '2018-07-11 13:33:57', 0);
...
(2, 'superadmin', 'admin', 'fauzia001@gmail.com', 'balai panjang', '08889999', '1b3231655cebb7a1f783eddf27d254ca', 'on'),
(6, 'customer', 'customer', 'customer1@aaa.com', 'jl.Customer Weshop', '088888', '5f4dcc3b5aa765d61d8327deb882cf99', 'on'),
(7, 'customer', 'dela', 'dela01', 'payakumbuh', '123456', '827ccb0eea8a706c4c34a16891f84e7b', 'on');
...
--
ALTER TABLE `barang`
  MODIFY `barang_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
